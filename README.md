...
本项目版本迭代至1.0.1，欢迎各位多多交流。

- [客户端前端服务器](https://github.com/steveay/seckill-front)
- [后台系统前端服务器](https://github.com/steveay/admin-manager)
...
## License
- [MIT](https://github.com/steveay/seckillcloud/blob/master/LICENSE)
