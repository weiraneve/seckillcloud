...
INSERT INTO `permission` VALUES (5, 'SIFT_ROLE', '筛选规则');
INSERT INTO `permission` VALUES (6, 'SIFT_ADMIN_USER', '筛选用户');
INSERT INTO `permission` VALUES (7, 'SETTING_ADMIN_USER', '系统设置');
INSERT INTO `permission` VALUES (8, 'MENU_ADMIN_USER', '菜单设置');
INSERT INTO `permission` VALUES (9, 'ROLE_ADMIN_USER', '角色管理');
INSERT INTO `permission` VALUES (10, 'ACCOUNT_ADMIN_USER', '账号管理');
INSERT INTO `permission` VALUES (11, 'PERMISSION_ADMIN_USER', '权限设置');
INSERT INTO `permission` VALUES (12, 'SETTING_UPDATE', '系统设置修改操作');
INSERT INTO `permission` VALUES (13, 'SETTING_ADD', '系统设置添加操作');
INSERT INTO `permission` VALUES (14, 'SRTTING_DELETE', '系统设置删除操作');
INSERT INTO `permission` VALUES (15, 'SETTING_SELECT', '系统设置查询操作');
INSERT INTO `permission` VALUES (16, 'SETTING_NORMAL_DELETE_USER', '正常模块删除权限');
INSERT INTO `permission` VALUES (17, 'SETTING_NORMAL_UPDATE_USER', '正常模块修改权限');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `permission_menu` VALUES (1, 1, 1, 1, NULL, 'Home', '首页', 'home');
...
INSERT INTO `permission_menu` VALUES (5, 1, 5, 5, NULL, 'Rule', '筛选规则', 'check-circle');
INSERT INTO `permission_menu` VALUES (6, 1, 6, 6, NULL, 'Sift', '筛选用户', 'user');
INSERT INTO `permission_menu` VALUES (7, 1, 7, 7, NULL, 'Setting', '系统设置', 'setting');
INSERT INTO `permission_menu` VALUES (8, 2, 8, 8, '7', 'Menu', '菜单设置', 'menu');
INSERT INTO `permission_menu` VALUES (9, 2, 9, 9, '7', 'Role', '角色管理', 'robot');
INSERT INTO `permission_menu` VALUES (10, 2, 10, 10, '7', 'Account', '账号管理', 'contacts');
INSERT INTO `permission_menu` VALUES (11, 2, 11, 11, '7', 'Permission', '权限设置', 'paper-clip');
COMMIT;
...
INSERT INTO `role_permission` VALUES (19, 2, '2');
INSERT INTO `role_permission` VALUES (20, 2, '3');
INSERT INTO `role_permission` VALUES (21, 2, '4');
INSERT INTO `role_permission` VALUES (22, 2, '5');
INSERT INTO `role_permission` VALUES (23, 2, '6');
COMMIT;
...
INSERT INTO `user_role_permission` VALUES (17, 1, 1, 17);
INSERT INTO `user_role_permission` VALUES (18, 2, 1, 1);
INSERT INTO `user_role_permission` VALUES (19, 2, 1, 2);
INSERT INTO `user_role_permission` VALUES (20, 2, 1, 3);
INSERT INTO `user_role_permission` VALUES (21, 2, 1, 4);
INSERT INTO `user_role_permission` VALUES (22, 2, 1, 5);
INSERT INTO `user_role_permission` VALUES (23, 2, 1, 6);
COMMIT;
