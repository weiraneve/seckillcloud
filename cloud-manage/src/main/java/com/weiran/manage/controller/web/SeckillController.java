...
public class SeckillController {
     ...
     */
    @GetMapping
    public Result seckillIndex(@RequestParam(value = "page", defaultValue = "1") Integer page, @RequestParam(value = "pageSize", defaultValue = "1") Integer pageSize, Long goodsId) {
